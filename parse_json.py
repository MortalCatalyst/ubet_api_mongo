...
def system_folder():
    if platform.system() == 'Linux':
        linux_folder = r'/home/sayth/OneDrive/Projects/Folder/Results/Rosehill_2018-06-30.json'
        return linux_folder
    else:
        windows_folder = r'C:\Users\Sayth\OneDrive\Projects\Folder\Results\Rosehill_2018-06-30.json'
        return windows_folder


with open(system_folder(), 'r') as f:
    DATA = json.load(f)
